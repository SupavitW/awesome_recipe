...
const createRecipeSchema = yup.object().shape({
    ...
    recipe_pic: yup.mixed().required("Recipe picture is required").test("is-valid-type", "File must be jpeg or png", value => isValidFileType(value && value.name.toLowerCase(), "image"))
});
